...
class TrackTrainController extends GetxController {
  // Mock Data
  final allTrains = [
    'Mohanagar Express',
    'Suborno Express',
  ...
  // Selected States
  final selectedTrain = 'Suborno Express'.obs;
  final currentStation = ''.obs;
  final targetStation = ''.obs;

  // Controllers
  final currentStationController = TextEditingController();
  ...
  void onTrack() {
    if (selectedTrain.value.isEmpty || currentStation.value.isEmpty || targetStation.value.isEmpty) {
      Get.snackbar(
        ...
        'Please select Train, Current Station, and Target Station to continue.',
    ...
    Get.toNamed(Routes.MAP_TRACKING);
  }
